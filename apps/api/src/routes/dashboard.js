...
exports.dashboardRoutes.use(auth_js_1.authMiddleware);
/**
 ...
 */
function generateWidgetData(widgetId, moduleId) {
    // Stat widgets
 ...
 */
exports.dashboardRoutes.get('/widgets/:widgetId', async (req, res) => {
 ...
 */
exports.dashboardRoutes.post('/modules/:moduleId/enable', async (req, res) => {
 ...
 */
exports.dashboardRoutes.post('/modules/:moduleId/disable', async (req, res) => {
    const { moduleId } = req.params;
    // TODO: Update tenant configuration in DB
    res.json({
